...
module.exports = ({ ApplicationError, logger }) => async (userId, id) => {
  ...
  const select =
    'name description image currency address freeServices generalServices hostelServices entertainmentServices foodServices rooms totalRate totalUsersRated totalOnlineBooking totalRevenue';
