...
module.exports = ({ ApplicationError, logger }) => async (userId, id) => {
  ...
  const select =
    'name description phone email managerEmail isHidden image currency address freeServices generalServices hostelServices entertainmentServices foodServices rooms rate totalUsersRated totalOnlineBooking totalRevenue';
