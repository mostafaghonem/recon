...
module.exports = ({
  ...
  const scheme = {
    ...
    toilet: {
      value: body.toilet,
      rules: new Builder()
        .required('يجب ادخال نوع الحمام')
        .isMember(toiletTypes).rules
    },
    Type: {
      value: body.Type,
  ...
  if (
    ...
    body.totalRooms < body.totalAvailableRooms
  )
    error.totalAvailableRooms = [
      'لا يمكن ان يكون عدد الاماكن المتاحة اكبر من عدد الاماكن'
    ];
