...
module.exports = async app => {
  ...
  app.use('/api/offices', offices.Router);
  ...
  app.use('/api/requests/uploaded/offices', uploadedOfficesRequests.Router);
  app.use('/api/requests/edit/offices', editOfficesRequests.Router);
